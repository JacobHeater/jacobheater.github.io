...
export const resume: IResume = {
  ...
  professionalSummary: [
    ...
    {
      variant: V.LinkedIn,
      text: 'Software engineer and engineering leader with 13+ years of experience spanning full-stack development, system architecture, and engineering management. I\u2019ve built and shipped production software across cybersecurity, healthcare, government, patent law, and enterprise SaaS \u2014 from designing database schemas and building CI/CD pipelines from scratch to standing up engineering teams and driving organizational change.\n\nMy technical foundation runs deep: TypeScript, JavaScript, C#, Python, React, Next.js, Angular, Node.js, and cloud platforms on AWS, Azure, and GCP. I\u2019ve written COM add-ins, Chrome extensions, O365 integrations, and Apps Script automations. I\u2019ve built Express microservices as NLP API interfaces, built custom MVC frameworks, designed plugin architectures with DI, and authored shared .NET libraries and Python SDKs used across product surfaces and Databricks.\n\nIn cybersecurity, I\u2019ve designed SOAR components, built dual-language phishing analysis engines with cross-language parity testing, designed shared Python SDKs on abstract base classes for extensibility, created metrics dashboards that scaled from a personal tool to org-wide production infrastructure on Docker, K8s, Terraform, and Argo CD \u2014 earning CEO recognition \u2014 and spearheaded Engineering Excellence initiatives standardizing SDLC across CyberDefense teams.\n\nIn healthcare, I built features for HAIMS \u2014 the largest healthcare artifact repository in the US \u2014 working with DICOM and HL7 standards and participating in multi-agency design sessions with military stakeholders. At USDA, I solely designed an Export module database schema using normalized reference tables for fully dynamic data requirements.\n\nI\u2019ve repeatedly built testing infrastructure and CI/CD from nothing: 0% to 80% coverage at Cofense, first-ever E2E suites at Deltek, performance testing frameworks at Swimlane, and customer integration mocks that directly drove retention.\n\nAfter serving as Senior Engineering Manager at Expel \u2014 where I managed 7 direct reports, promoted 4 engineers, containerized an internal metrics app to GCP, and stayed hands-on enough to personally ship React components and build dashboard designers \u2014 I returned to individual contribution because I love building things. I bring an uncommon combination of production-level coding ability and executive perspective on team building and delivery strategy.\n\nI\u2019m at my best solving hard problems, building systems from the ground up, and making the people around me more effective.',
    },
  ],
  experience: [
    {
