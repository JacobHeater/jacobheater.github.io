  ...
  experience: [
    {
      ...
      keyPoints: [
        ...
        'Took over and rebuilt the sales-target system from the ground up using a proprietary sales prediction algorithm, correcting anomalies in the prior model — including stores with $64K in actual sales carrying a $5K target, and low-performing stores in high trade-area-exposure zones assigned targets far above their realistic performance bracket.',
