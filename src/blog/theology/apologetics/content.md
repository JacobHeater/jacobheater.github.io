My approach to <abbr title="The branch of theology concerned with defending religious doctrines through systematic argumentation and discourse">apologetics</abbr> is to engage with theology, especially
Christian theology, from the least <abbr title="Asserting opinions as if they were undisputed facts; characterized by an authoritative, arrogant assertion of unproved principles">dogmatic</abbr> perspective possible.
...
It's my belief that the <abbr title="A foundation or basis; something that provides support from beneath">underpinning</abbr> of philosophy and its various schools
...
It can be done through logic—and yes, even <abbr title="Based on observation or experience rather than theory or pure logic; verifiable through experimentation">empirical</abbr> evidence.
...
this position is <abbr title="Founded or based on; dependent upon as a condition or cause">predicated</abbr> on the notion that God is extraordinary, or
...
in order for it to be true, one necessarily must ignore the <abbr title="A sequence of reasoning or justification that goes on indefinitely, where each step requires further explanation leading to an endless chain">infinite regress</abbr>
that comes of it. Ignoring <abbr title="Errors in reasoning that invalidate an argument; flawed logic">logical fallacies</abbr> or unproven information
